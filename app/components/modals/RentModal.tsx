...
const RentModal = () => {
	...
	if (step === STEPS.INFO) {
		bodyContent = (
			<div className="flex flex-col gap-8">
				...
				<Counter
					title="Rooms"
					subtitle="How many rooms are on your property?"
					value={roomCount}
				...
				<Counter
					title="Bathrooms"
					subtitle="How many bathrooms are your property?"
					value={bathroomCount}
	...
	if (step === STEPS.PRICE) {
		bodyContent = (
			<div className="flex-flex-col gap-8">
				<Heading
					title="Enter your desired price"
					subtitle="What is your rate per night?"
				/>
				<Input
					id="price"
					label="Price"
